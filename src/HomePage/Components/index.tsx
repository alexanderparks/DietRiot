  ...
  return (
    <div className="homePage">
            ...
            >
              ...
              <div className="text-center">
                <a
                  ...
                  role="button"
                  data-toggle="button"
                  style={{ marginBottom: "100px", fontFamily: "verdana" }}
                >
                  Pick Ingredients
                </a>
              </div>
      ...
      >
        ...
        >
          Finding and managing recipes and ingredients can often be the hardest
          part of sticking to a diet. Our team set out to alleviate this issue
          when we created DietRiot. With DietRiot, users can browse and compare
          recipes and ingredients that fit the restrictions of their diet. Users
          can also utilize DietRiot to view attributes and statistics about
          specific recipes, ingredients, or diet groups. Whether a user is
          beginning a diet, continuing a diet, or just looking for some new
          recipes, DietRiot provides an expansive and easily navigable medium to
...
export { NavigationBar, HomePageLanding };
